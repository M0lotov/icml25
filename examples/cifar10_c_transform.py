...
def frost(x, severity=1):
    ...
    filename = ['./corrupt/frost1.png', './corrupt/frost2.png', './corrupt/frost3.png', './corrupt/frost4.jpg', './corrupt/frost5.jpg', './corrupt/frost6.jpg'][idx]
    frost = cv2.imread(filename)
    frost = cv2.resize(frost, (0, 0), fx=1.4, fy=1.4)
...
transforms = ['Gaussian Noise', 'Shot Noise', 'Impulse Noise', 'Defocus Blur', 'Glass Blur', 'Motion Blur', 'Zoom Blur',
              'Snow', 'Frost', 'Fog', 'Brightness', 'Contrast', 'Elastic', 'Pixelate', 'JPEG', 'Speckle Noise',
